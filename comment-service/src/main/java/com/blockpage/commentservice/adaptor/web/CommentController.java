...
public class CommentController {
    ...
    public ResponseEntity<ApiResponseView<String>> pinComment(@PathVariable Long commentId) {
    ...
    public ResponseEntity<ApiResponseView<String>> deleteComment(@PathVariable Long commentId) {
